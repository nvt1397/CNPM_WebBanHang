					...
					<ul class="main-categories">
						<li class="main-nav-list"><a data-toggle="collapse" href="#homeClean" aria-expanded="false" aria-controls="homeClean"><span
							...
							<ul class="collapse" id="homeClean" data-toggle="collapse" aria-expanded="false" aria-controls="homeClean">
								<li class="main-nav-list child"><a href="#" catalog_id="1">Giày thể thao nam</a></li>
								<li class="main-nav-list child"><a href="#" catalog_id="2">Giày thể thao nữ</a></li>
							</ul>
						</li>
						<li class="main-nav-list"><a data-toggle="collapse" href="#beauttyProduct" aria-expanded="false" aria-controls="beauttyProduct"><span
							...
							<ul class="collapse" id="beauttyProduct" data-toggle="collapse" aria-expanded="false" aria-controls="beauttyProduct">
								<li class="main-nav-list child"><a href="#" catalog_id="3">Giày bệt nam</a></li>
								<li class="main-nav-list child"><a href="#" catalog_id="4">Giày bệt nữ</a></li>
							</ul>
						</li>
						<li class="main-nav-list"><a href="#" catalog_id="5">Dép quai hậu</a></li>
						<li class="main-nav-list"><a href="#" catalog_id="6">Giày dép trẻ em</a></li>
						<li class="main-nav-list"><a href="#" catalog_id="7">Sản phẩm khác</a></li>
					</ul>
				</div>
